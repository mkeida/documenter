            ...
            <el-menu class='aside'
                ...
                <el-submenu index='-1'>
                    ...
                    <el-submenu v-for='doc in documents' :index='doc.id' :key='doc.id'>
                        ...
                        <!-- Sekce -->
                        <el-menu-item v-for='(section, i) in doc.sections'
                                      :index='`${doc.id}-${section.id}+${i}`'
                                      :key='`${doc.id}-${section.id}`'
                                      @click='menuItemClick'><span v-html='section.name'></span></el-menu-item>
                    </el-submenu>
                </el-submenu>
            </el-menu>
        </aside>
            ...
            menuItemClick(e) {
                ...
                if (this.activeDoc != documentId) {
                    ...
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $($('.s-header-2')[sectionId.split('+')[1]]).offset().top - 50
                    }, 500);
                }
            },
