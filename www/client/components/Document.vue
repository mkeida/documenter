    ...
    <div class='document-wrapper'>
        ...
        <div class='document' id='document' v-if='!error'>
            ...
            <div v-for='(block, index) in data.blocks' :data-type='block.type'>
                ...
                <!-- Komponenta -->
                <component :is=`partial-${block.type}` :data='block.data' :key='Math.random().toString(36).substr(2, 9)'></component>
            </div>
            <!-- Autoři -->
            ...
            did: function (now, prev) {
                ...
                Vue.nextTick(() => {
                    FB.Event.subscribe('edge.create', function(response) {
                        window.top.location.href = `${window.location.href}#${this.document}`;
                    });
...
<style lang="scss">
    ...
    .inline-code {
        ...
        background-color: rgba(#b44437, 0.075) !important;
