...
class Secrets
{
	...
	protected $notificationEmail = 'marek.kejda@ssps.cz';

	// E-mail address to use in notifications to normal users
	protected $noreplyEmail = 'noreply@ssps.cz';

	// Unique encryption key (case-sensitive)
	protected $encryptionKey = 'jrcn221H';
	...
	protected $adminPassword = '246810*#';
	...
	// Database name
	protected $databaseName = 'skriptasspscz';

	// SQL database host name
	protected $databaseHost = '172.27.0.20';

	// SQL database port number
	protected $databasePort = '3306';

	// SQL database login user
	protected $databaseUser = 'skriptasspscz';

	// SQL database login password
	protected $databasePassword = 'uup8uQuewoz9Ieya';
