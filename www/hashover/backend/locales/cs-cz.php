...
$locale = array (
	'comment-form'		=> 'Váš komentář...',
	'reply-form'		=> 'Vaše odpověď...',
	'comment-formatting'	=> 'Formátování',
	'allowed-html'		=> 'Povolené HTML',
	'allowed-markdown'	=> 'Markdown formát',
	'html-format'		=> '&lt;b&gt;, &lt;strong&gt;, &lt;u&gt;, &lt;i&gt;, &lt;em&gt;, &lt;s&gt;, &lt;big&gt;, &lt;small&gt;, &lt;sup&gt;, &lt;sub&gt;, &lt;pre&gt;, &lt;ul&gt;, &lt;ol&gt;, &lt;li&gt;, &lt;blockquote&gt;, &lt;code&gt; sanitizuje HTML, URL jsou automaticky přeloženy na linky a [img]URL[/img] zobrazí externí obrázek.',
	'markdown-format'	=> '**Tučně**, _podtrhnout_, *kurzíva*, ~~přeškrtnout~~, `zvýraznit`, ```kód``` sanitizuje HTML. HTML a Markdown může být v komentáři použito dohromady.',
	'post-button'		=> 'Přidat komentář',
	'login'			=> 'Přihlásit',
	'login-tip'		=> 'Přihlásit (dobrovolné)',
	'logout'		=> 'Odhlásit',
	'be-first-name'		=> 'Zatím žádné komentáře.',
	'pending-name'		=> 'Pending...',
	'deleted-name'		=> 'Smazáno...',
	'error-name'		=> 'Chyba...',
	'be-first-note'		=> 'Buďte první komentující!',
	'login-required'	=> 'Ke komentování musíte být přihlášeni!',
	'pending-note'		=> 'This comment is pending approval.',
	'deleted-note'		=> 'Tento komentář byl smazán.',
	'error-note'		=> 'Something went wrong. Could not retrieve this comment.',
	'options'		=> 'Nastavení',
	'cancel'		=> 'Zrušit',
	'reply-to-comment'	=> 'Odpovědět na komentář',
	'edit-your-comment'	=> 'Editovat komentář',
	'optional'		=> 'Dobrovolné',
	'required'		=> 'Povinné',
	'name'			=> 'Jméno',
	'name-tip'		=> 'Jméno (%s)',
	'password'		=> 'Heslo',
	'password-tip'		=> 'Heslo (%s, dovolí editovat nebo smazat komentář)',
	'confirm-password'	=> 'Potvrdit heslo',
	'email'			=> 'E-mailová adresa',
	'email-tip'		=> 'E-mailová adresa (%s, pro e-mailové notifikace)',
	'website'		=> 'Web',
	'websites'		=> 'Weby',
	'website-tip'		=> 'Web (%s)',
	'logged-in'		=> 'Byl jsi úspěšně přihlášen!',
	'logged-out'		=> 'Byl jsi úspěšně odhlášen!',
	...
	'subscribe'		=> 'Upozornit mě na odpovědi',
	...
	'post-a-comment'	=> 'Přidat komentář ke knize',
	'post-a-comment-on'	=> 'Přidat komentář na "%s"',
	'most-popular-comment'	=> 'Most Popular Comment',
	'most-popular-comments'	=> 'Most Popular Comments',
	'showing-comment'	=> '%d komentář',
	'showing-comments'	=> '%d komentáře',
	...
	'setting-time-format'			=> 'Time format, use "H:i" for 24-hour time',
